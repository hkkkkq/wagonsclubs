<template>
    <div style="font-family: PingFangSC-Medium, sans-serif;background:#0f1923;border:0px solid #3d454d">
        ...
        <p class="co">
            <span>自驾出行</span>-拉风、炸街、稀有车型，WAGONS豪华车型矩阵让追求极致驾驭的您时刻拥有新鲜体验</p>
        <p class="co">
            <span>商务接待</span>-劳斯莱斯、宾利超豪华座驾接驾，让尊贵的您和尊贵的客人坐享极致奢华。</p>
        <p class="co">
            <span>婚庆静展</span>-豪华婚礼、高端展示，WAGONS顶级豪车成就您的非凡场面。</p>
        <p class="co">
            <span>影视拍摄</span>-提供各类影视拍摄用车，车型丰富，满足多场景用车需求。</p>
        <p class="co">
            <span>广告服务</span>-超跑炫目的车身，永远是广告主渴求的黄金位置。</p>
        <P class="co">
            <span>豪车托管</span>-WAGNOS通过专业细致的爱车管理服务，为您发掘爱车的最大价值。</P>
        <P class="co">
            <span>专业修理维护</span>-WAGONS汽车维护中心依据您对爱车的基本保养和安全要求，为您定制可靠专业的维护修理服务。</P>
        <div class="bo"></div>
        <p class="ti">车辆托管</p>
