    ...
    <div class="car-con">
      ...
      <div class="intro">
        ...
        <div class="right">
          ...
          <span style="color: #8e8e8e;font-size: 12px;display: block;position: relative;top: 20px;left: 80px;">VIP价格:</span>
          <span style="color: #8e8e8e;font-size: 12px;display: block;text-align: right;margin-right: 9px;margin-top: 8px;">{{currentcar.car.vipPrice}} 元/天</span>
        </div>
      </div>
      <div class="car_list">
        <div class="box">
