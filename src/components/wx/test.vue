<template>
  <div>
      ...
      <a href="http://localhost:8080/wx/findcar?WAG=oZyXk0rsoVgmkc7pEBmxP7DPce0s">找车</a>
      <br>
      <!-- <a href="http://www.test.wagonsclub.com/wx/hd?WAG=test1">活动</a> -->
      <a href="http://localhost:8080/wx/hd?WAG=oZyXk0rsoVgmkc7pEBmxP7DPce0s">活动</a>
      <br>
      会员中心
      <br>
      ...
      <a href="http://localhost:8080/wx/orders?WAG=oZyXk0rsoVgmkc7pEBmxP7DPce0s">订单查询</a>
      <br>
